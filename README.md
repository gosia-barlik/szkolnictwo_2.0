...
- in src/components create SearchForm, CocktailList, QualificationCard
- render SearchForm and CocktailList in Landing
- pass drinks, iterate over and render in QualificationCard
...
#### CocktailList and QualificationCard CSS (optional)
